...
<div className="SuperAdminPanel">
 ...
 <div className="centreTopOne">
   {adminsData&&(<h2>{adminsData.companyAdminsCount} {adminsData.companyAdminsCount == 1 || adminsData.companyAdminsCount == 0? 'Registered' : 'Registered'}</h2>)}
 </div>
