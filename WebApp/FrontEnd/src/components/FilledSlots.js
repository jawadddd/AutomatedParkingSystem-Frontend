...
const FilledSlots = ({adminIs}) => {
  ...
  useEffect(() => {
    const fetchAvailableSlots = async () => {
      try {
        const response = await axios.get(`${SERVERURL}/api/v1/getFilledSlots`, {
          params: {
  ...
  return (
    <motion.div 
      ...
      <h2 className="text-2xl font-bold mb-4">Filled Slots</h2>
      <div className="mb-4">
        <input
          type="text"
          placeholder="Search..."
